...
#ifndef __RASPBERRY_IO_RESOURCE_SEEKABLE_INPUT_STREAM_H__
#define __RASPBERRY_IO_RESOURCE_SEEKABLE_INPUT_STREAM_H__ 1
...
#endif /* __RASPBERRY_IO_RESOURCE_SEEKABLE_INPUT_STREAM_H__ */
