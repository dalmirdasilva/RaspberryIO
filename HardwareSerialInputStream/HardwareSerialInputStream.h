...
#ifndef __RASPBERRY_IO_HARDWARE_SERIAL_INPUT_STREAM_H__
#define __RASPBERRY_IO_HARDWARE_SERIAL_INPUT_STREAM_H__ 1
...
#endif /* __RASPBERRY_IO_HARDWARE_SERIAL_INPUT_STREAM_H__ */
